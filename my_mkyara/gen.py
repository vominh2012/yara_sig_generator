...
class YaraGenerator(object):
    ...
    def add_chunk(self, data, offset=0, is_data=False, chunk_name=""):
        self._chunks.append(DataChunk(data, offset=offset, is_data=is_data))
        self._chunk_names.append(chunk_name)
    ...
    def _process_instruction(self, ins, with_comment=False):
    ...
    def generate_rule(self):
        ...
        for chunk in self._chunks:
            if (self._chunk_names):
                chunk_id = "$" + self._chunk_names[chunk_nr]
            else:
            ...
            if chunk.is_data is False:
                ...
                for ins in disasm:
                    rule_part, comment = self._process_instruction(ins, self.do_comment_sig)
